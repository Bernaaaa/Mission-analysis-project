...
arg1 = atan( sqrt((1-e)/(1+e)) * tan(th1 /2) );

if arg1  < 0 
    arg1 = pi + arg;  % Ensure the argument is in the range [0, 2*pi]
end

E1 = 2 * arg1;


   % Eccentric anomaly at th1
arg2 =atan( sqrt((1-e)/(1+e)) * tan(th2 /2) );   % Eccentric anomaly at th2

if arg2  < 0 
    arg2 = pi + arg2;  % Ensure the argument is in the range [0, 2*pi]
end
