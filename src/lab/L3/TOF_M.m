function deltat = TOF_M(a, e, th1, th2, mu)
% Time of Flight 
%
% Syntax: deltat = TOF_M(a, e, th1, th2, mu)
%
% Inputs:
...
% - The time of flight is computed using the difference in mean anomalies corresponding to the two true anomalies, divided by the mean motion of the orbit.
    ...
    % Display the time of flight in seconds and also in (days, hours, minutes, seconds) format for better readability.
